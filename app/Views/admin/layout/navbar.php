<div id="app-sidepanel" class="app-sidepanel">
    ...
    <div class="sidepanel-inner d-flex flex-column">
        ...
        <div class="app-branding">
            <a class="app-logo" href="<?= base_url('admin/dashboard') ?>"><img class="logo-icon me-2" src="<?= base_url('web2bahasa.png') ?>" style="width: auto;" alt="logo"></a>
        </div><!--//app-branding-->
        ...
        <nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1">
            <ul class="app-menu list-unstyled accordion" id="menu-accordion">
                ...
                <li class="nav-item">
                    <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                    <a class="nav-link <?= (current_url() == base_url('admin/kategoriAktivitas/index') ? 'active' : '') ?>" href="<?= base_url('admin/kategoriAktivitas/index') ?>">
                        <span class="nav-icon">
                        ...
                        <span class="nav-link-text">Kategori Aktivitas</span>
                    </a><!--//nav-link-->
                </li><!--//nav-item-->
                ...
                <li class="nav-item">
                    <a class="nav-link <?= (current_url() == base_url('admin/sosmed') ? 'active' : '') ?>" href="<?= base_url('admin/sosmed') ?>">
                        <span class="nav-icon">
                ...
                <li class="nav-item">
                    <a class="nav-link <?= (current_url() == base_url('admin/marketplace') ? 'active' : '') ?>" href="<?= base_url('admin/marketplace') ?>">
                        <span class="nav-icon">
                ...
                <li class="nav-item">
                    <a class="nav-link <?= (current_url() == base_url('admin/form') ? 'active' : '') ?>" href="<?= base_url('admin/form') ?>">
                        <span class="nav-icon">
                            <svg fill="#000000" width="16" height="16" class="bi bi-card-checklist" viewBox="0 0 32 32" version="1.1" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                ...
                                <path d="M22,19.17l-.78.79A1,1,0,0,0,22,19.17Z" class="clr-i-outline clr-i-outline-path-4"></path>
